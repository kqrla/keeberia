...
- three files, filed at `backend/cad/research/reference/genkeyboard/`: the library, a 104-key build, a 2x3 keypad. license unknown — treat as study-don't-copy until anne knows its source
