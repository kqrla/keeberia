...
research: sept 8 2026 · method: rmk docs scraped from rmk.rs (their llms.txt is excellent) + rmk-rs/rmk repo; qmk/kmk facts from prior working knowledge, flagged where stale-ness is possible · written for the backend/firmware/firmware.md decision
